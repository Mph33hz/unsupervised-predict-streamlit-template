...
def collab_model(movie_list,top_n=10):
    ...
    """
    movie_c = movies_df.copy()
    movie_c = movie_c.set_index('movieId')
    indices = pd.Series(movie_c['title'])
    ...
    # commented out ## cosine_sim = cosine_similarity(np.array(df_init_users), np.array(df_init_users))
